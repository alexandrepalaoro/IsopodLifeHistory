...
## Checking the differences between populatons...
...
# Again, differences are not relevant - no need for a GLMM 

par(mfrow=c(1,1))

# A simple OLS will do. The size distribution is normal-ish, and the residuals 
# are homokedastic. Thus, no reason not to use it.
